        ...
        return `
            (() => {
                ...
                Object.getOwnPropertyNames = function(obj) {
                    ...
                    if (obj === navigator) {
                        // Return empty array as expected by bot detector
                        return [];
                    }
                    return props;
                };
                ...
                // User agent spoofing with proper Chrome version detection
                const realisticUserAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.6099.109 Safari/537.36';
                ...
                Object.defineProperty(navigator, 'appVersion', {
                    get: () => '5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.6099.109 Safari/537.36',
                    configurable: true,
                    enumerable: false
                });
                ...
                // Define dummyFn as required by bot detector
